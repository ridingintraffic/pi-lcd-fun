...
def connected(client):
    ...
    print('Connected to Adafruit IO!  Listening for {0} changes...'.format(group_name))
...
def message(client, feed_id, payload):
    ...
    DATA_MESSAGES.update({feed_id: payload})
    print(DATA_MESSAGES[feed_id])
